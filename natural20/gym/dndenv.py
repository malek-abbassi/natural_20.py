...
class dndenv(gym.Env):
    ...
    def __init__(self, view_port_size=(12, 12), max_rounds=200, render_mode = None, **kwargs):
        ...
        self.observation_space = gym.spaces.Dict(spaces={
            ...
            "ally_name" : gym.spaces.Text(max_length=20),
            "enemy_name" : gym.spaces.Text(max_length=20),
            "ally_ac" : gym.spaces.Box(low=0, high=1, dtype=float),
            "enemy_ac" : gym.spaces.Box(low=0, high=1, dtype=float),
            "health_pct": gym.spaces.Box(low=0, high=1, shape=(1,), dtype=float),
            "health_ally": gym.spaces.Box(low=0, high=1, dtype=float),
            "health_enemy": gym.spaces.Box(low=0, high=1, dtype=float),
            "ally_reactions": gym.spaces.Box(low=0, high=1, dtype=int),
            "enemy_reactions": gym.spaces.Box(low=0, high=1, dtype=int),
            "ally_conditions": gym.spaces.Box(low=0, high=1, dtype=int),
            "enemy_conditions": gym.spaces.Box(low=0, high=1, dtype=int),
            "player_type": gym.spaces.Box(low=0, high=1, shape=(1,), dtype=int),
            "ally_type": gym.spaces.Box(low=0, high=1, dtype=int),
            "enemy_type": gym.spaces.Box(low=0, high=1, dtype=int),
